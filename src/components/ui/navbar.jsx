...
const Navbar = () => {
  ...
  return (
    <nav>
      <div className="nav-container flex justify-between items-center max-w-[1200px] mx-auto my-0 mt-8 p-5">
        <div className="title">
          <NavLink to="/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              id="yt-logo-updated-svg_yt7"
        ...
        <div className="nav-icon" onClick={HandleNavOpen}>
          <span
            className="text-black text-3xl cursor-pointer transition-all duration-300 ease-in-out"
      ...
      {isOpenNav && (
        <ul className="max-w-[1200px] mx-auto my-0 mt-2 py-3 flex flex-col justify-center items-center gap-3 bg-black rounded-lg">
